								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" placeholder="https://www.youtube.com/watch?v=TbbV_b4y-gc">
										</div>
										<div class="form-group">
											<label>Preacher (if Applicable)</label>
											<select class="select">
													<option value="AK" selected="selected">Select Preacher</option>

													<option value="AK">Bethel AG, Bangalore</option>
													<option value="HI">Living Gospel Church, Bangalore</option>
