								...
								<div class="panel panel-flat">
									...
									<div class="panel-body">
										<div class="form-group">
											...
											<input type="text" value="<?php if(isset($thiscateg)) { echo $thiscateg->categoryName; } ?>" name="categoryName" class="form-control" placeholder="Eg: Bible Study">
										</div>
						...
						<table class="table datatable-multi-sorting">
							...
							<tbody>
								...
								<tr style="background-color:<?php echo $bgc; ?>" >
									<td><?php echo $i; ?></td>
									<td><?php echo $categ['categoryName']; ?></td>
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<?php } ?>
													...
													<li><a href="<?php echo base_url(); ?>admin/articles/deletecateg/<?php echo $categ['id']; ?>"><i class="icon-database-remove"></i> Delete</a></li>
												</ul>
											</li>
										</ul>
									</td>
