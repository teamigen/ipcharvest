...
<head>
	...
	<title>IPC Harvest | Whitefield</title>
	...
	<link href="<?php echo base_url(); ?>assets/admin/assets/css/colors.css" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/assets/js/plugins/forms/validation/validate.min.js"></script>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/assets/js/pages/login_validation.js"></script>
	<!-- /theme JS files -->
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content pb-20">
					...
					<form action="<?php echo base_url() ?>admin/login/authorize" method="post" class="form-validate">
						<div class="panel panel-body login-form">
							<div class="text-center">
								<div class="icon-object border-slate-300 text-slate-300"><img class="img-responsive" style="max-width:60px; max-height:60px;" src="<?php echo base_url(); ?>assets/images/ipclogo.jpeg" /></div>
